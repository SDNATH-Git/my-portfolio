...
const Contact = () => {
    ...
    return (
        <section id="contacts" className="bg-gradient-to-r from-gray-900 to-gray-800 mx-5 lg:mx-10 py-8 mb-28 px-6 rounded-2xl border-t-6 border-orange-500 hover:shadow-xl shadow-orange-500/60 ">
