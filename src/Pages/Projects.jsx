...
//                         className="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-4 md:p-6 flex flex-col lg:flex-row gap-6 mb-8 border-l-4 border border-white"
//                     >
//                         {/* Left: Carousel */}
...
// ✅ Cholo – Ride Sharing Project Images
import p4_1 from "../assets/project4-1.png";
import p4_2 from "../assets/project4-2.png";
import p4_3 from "../assets/project4-3.png";
import p4_4 from "../assets/project4-4.png";
            ...
            <div>
                ...
                {projects.map((project, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true, amount: 0.3 }}
                        transition={{ duration: 0.6, delay: index * 0.2 }}
                        className={`bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-4 md:p-6 flex flex-col lg:flex-row gap-6 mb-8 hover:shadow-xl shadow-orange-500  border-orange-500 ${index % 2 === 0 ? "border-l-6" : "border-r-6"
                            }`}
                    >
                        {/* Left: Carousel */}
                        <div className="lg:w-1/2 w-full rounded-lg overflow-hidden shadow-lg">
