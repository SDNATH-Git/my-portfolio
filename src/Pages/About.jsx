...
const About = () => {
    return (
        <div
            id="about"
            className="text-white bg-gradient-to-r from-gray-900 to-gray-800 mx-5 md:mx-5 lg:mx-10 p-6 rounded-3xl shadow-xl my-16  hover:border-l-4 hover:border-r-4 hover:border-orange-500
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <div>
                            <img src="https://i.ibb.co.com/5WbmQS6B/img1.png" alt="Shuvo 1" className="h-90" />
                        </div>
                        <div>
                            <img src="https://i.ibb.co.com/fGG7L72k/shuvo3.png" alt="Shuvo 2" className="h-90" />
                        </div>
                        <div>
                            <img src="https://i.ibb.co.com/wZHdH15B/sd.jpg" alt="Shuvo 2" className="h-90" />
                        </div>
                        <div>
                            <img src="https://i.ibb.co.com/Cp3wff9C/shuvo-2.png" alt="Shuvo 3" className="h-90" />
                        </div>
                    </Carousel>
                </motion.div>
